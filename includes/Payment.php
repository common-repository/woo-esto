...
function init_woocommerce_esto_payment() {
    ...
    class WC_Esto_Payment extends WC_Payment_Gateway {
        ...
        public $only_specific_countries = [];
        ...
        public function __construct()
        {
            ...
            $this->only_specific_countries = $this->get_option( 'only_specific_countries' );
        ...
        function init_form_fields() {
            ...
            $this->form_fields = array(
                ...
                'only_specific_countries' => [
                    'title'       => __( 'Only specific countries', 'woo-esto' ),
                    'type'        => 'multiselect',
                    'class'       => 'wc-enhanced-select',
                    'options'     => WC()->countries ? WC()->countries->get_countries() : esto_get_countries(),
                    'default'     => [],
                    'description' => __( 'Specify countries where this payment method is available. Takes priority over "disabled countries". Leave empty to sell everywhere.', 'woo-esto' ),
                    'desc_tip'    => true
                ],
        ...
        public function is_available() {
            ...
            $disabled_countries                 = array_filter( (array)$this->disabled_countries );
            $disabled_countries_for_this_method = array_filter( (array)$this->disabled_countries_for_this_method );
            $only_specific_countries            = array_filter( (array)$this->only_specific_countries );

            if ( ! empty( $disabled_countries ) || ! empty( $disabled_countries_for_this_method ) || ! empty( $only_specific_countries ) ) {
                ...
                if ( $country && ! empty( $only_specific_countries ) && ! in_array( $country, $only_specific_countries ) ) {
                    return false;
                }
